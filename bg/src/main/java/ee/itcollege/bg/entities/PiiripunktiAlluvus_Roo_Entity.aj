...
privileged aspect PiiripunktiAlluvus_Roo_Entity {
    ...
    @Column(name = "id")
    private Long PiiripunktiAlluvus.id;
    
    @Version
    @Column(name = "version")
    private Integer PiiripunktiAlluvus.version;
    
    public Long PiiripunktiAlluvus.getId() {
        return this.id;
    }
    
    public void PiiripunktiAlluvus.setId(Long id) {
        this.id = id;
    }
    ...
    public void PiiripunktiAlluvus.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            PiiripunktiAlluvus attached = PiiripunktiAlluvus.findPiiripunktiAlluvus(this.id);
