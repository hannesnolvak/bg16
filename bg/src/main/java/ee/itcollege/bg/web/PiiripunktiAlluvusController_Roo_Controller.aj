...
privileged aspect PiiripunktiAlluvusController_Roo_Controller {
    ...
    public String PiiripunktiAlluvusController.create(@Valid PiiripunktiAlluvus piiripunktiAlluvus, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/piiripunktialluvuses/" + encodeUrlPathSegment(piiripunktiAlluvus.getId().toString(), httpServletRequest);
    }
    ...
    public String PiiripunktiAlluvusController.show(@PathVariable("id") Long id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("piiripunktialluvus", PiiripunktiAlluvus.findPiiripunktiAlluvus(id));
    ...
    public String PiiripunktiAlluvusController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("piiripunktiAlluvus", PiiripunktiAlluvus.findPiiripunktiAlluvus(id));
        addDateTimeFormatPatterns(uiModel);
        return "piiripunktialluvuses/update";
    }
    ...
    public String PiiripunktiAlluvusController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        PiiripunktiAlluvus.findPiiripunktiAlluvus(id).remove();
        uiModel.asMap().clear();
    ...
    void PiiripunktiAlluvusController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("piiripunktiAlluvus_alates_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("piiripunktiAlluvus_kuni_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
