...
privileged aspect VaeosaAlluvusController_Roo_Controller {
    ...
    public String VaeosaAlluvusController.create(@Valid VaeosaAlluvus vaeosaAlluvus, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        return "redirect:/vaeosaalluvuses/" + encodeUrlPathSegment(vaeosaAlluvus.getId().toString(), httpServletRequest);
    }
    ...
    public String VaeosaAlluvusController.show(@PathVariable("id") Long id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("vaeosaalluvus", VaeosaAlluvus.findVaeosaAlluvus(id));
    ...
    public String VaeosaAlluvusController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        uiModel.addAttribute("vaeosaAlluvus", VaeosaAlluvus.findVaeosaAlluvus(id));
        addDateTimeFormatPatterns(uiModel);
        return "vaeosaalluvuses/update";
    }
    ...
    public String VaeosaAlluvusController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        VaeosaAlluvus.findVaeosaAlluvus(id).remove();
        uiModel.asMap().clear();
